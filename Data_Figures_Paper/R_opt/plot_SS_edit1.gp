...
if (output_format eq "png") {
    ...
    set output "SS_energy_vs_distance.eps"
} else {
    set terminal wxt 1 size 900,900 enhanced font "Arial,18"
    set output
}}

set title "SS Interaction: Energy Distance" font "Arial,22" offset 0,-0.5
...
input_data_file = "E_Ropt_minmax_SS.dat"
gray_data_file = "../E_Ropt_SS.dat"
all_data_file = "../E_all_SS.dat"
