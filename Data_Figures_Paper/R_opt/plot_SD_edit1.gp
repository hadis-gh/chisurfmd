...
input_data_file = "E_Ropt_minmax_SD.dat"
gray_data_file = "../E_Ropt_SD.dat"
all_data_file = "../E_all_SD.dat"
...
# ================================
array config_phi1[4] = [0.0,   9.0,       0.0,       196.0]
array config_chi[4] =  [0.0,   14.0,      0.0,       212.0]
array config_zeta[4] = [0.0,   0.55875,   1.210625,  0.0]

array config_phi2[4]
do for [i=1:4] {
    config_phi2[i] = config_chi[i] - config_phi1[i]
}
