...
# Create side-by-side subplot layout (1 row, 2 columns)
set multiplot layout 1,2

# =============================================================================
# FIRST SUBPLOT: Single-Single (SS) data
# =============================================================================
set title "Single-Single (SS) Configurations"

plot \
    "../E_Ropt_SS.dat" using 4:($5-2*ref_energy) every sampling_interval pointtype 7 pointsize point_size_gray linecolor rgb gray_points_color title "Optimum distances (all configs)", \
    "../E_all_SS.dat" using (($1==config1_phi1 && $2==config1_phi2 && $3==config1_zeta) ? $4 : 1/0):(($1==config1_phi1 && $2==config1_phi2 && $3==config1_zeta) ? $5-2*ref_energy : 1/0) with linespoints pointtype 5 pointsize point_size_config linecolor rgb config1_color title config1_label, \
    "../E_all_SS.dat" using (($1==config2_phi1 && $2==config2_phi2 && $3==config2_zeta) ? $4 : 1/0):(($1==config2_phi1 && $2==config2_phi2 && $3==config2_zeta) ? $5-2*ref_energy : 1/0) with linespoints pointtype 5 pointsize point_size_config linecolor rgb config2_color title config2_label, \
    "../E_all_SS.dat" using (($1==config3_phi1 && $2==config3_phi2 && $3==config3_zeta) ? $4 : 1/0):(($1==config3_phi1 && $2==config3_phi2 && $3==config3_zeta) ? $5-2*ref_energy : 1/0) with linespoints pointtype 5 pointsize point_size_config linecolor rgb config3_color title config3_label, \
    "../E_all_SS.dat" using (($1==config4_phi1 && $2==config4_phi2 && $3==config4_zeta) ? $4 : 1/0):(($1==config4_phi1 && $2==config4_phi2 && $3==config4_zeta) ? $5-2*ref_energy : 1/0) with linespoints pointtype 5 pointsize point_size_config linecolor rgb config4_color title config4_label

# =============================================================================
# SECOND SUBPLOT: Double-Double (DD) data
# =============================================================================
